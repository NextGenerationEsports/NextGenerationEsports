        ...
        >
          <div className="bg-card/50 border border-primary/30 p-8 rounded-xl text-center max-w-md backdrop-blur-sm">
            ...
            <div className="flex gap-2">
              <input type="email" placeholder="Email address" className="flex-grow bg-background border border-card-border rounded-lg px-4 py-2 text-sm focus:outline-none focus:border-primary" />
