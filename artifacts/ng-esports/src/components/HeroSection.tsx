...
export function HeroSection() {
  return (
    <section className="relative min-h-[100dvh] flex items-center justify-center overflow-hidden pt-16" data-testid="hero-section">
      {/* Background Elements */}
      ...
      <div className="absolute inset-0 overflow-hidden z-0 pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-[30rem] h-[30rem] bg-indigo-600/10 rounded-full blur-[150px] animate-pulse" style={{ animationDuration: '6s', animationDelay: '1s' }} />
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10 flex flex-col items-center text-center">
        <motion.div
          ...
          className="mb-8"
        >
          <img src="/ng-logo-white.png" alt="NG Logo" className="w-24 md:w-32 h-auto mx-auto drop-shadow-[0_0_15px_rgba(124,58,237,0.5)]" />
        </motion.div>
        ...
        >
          Next Generation <br/>
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-purple-400 to-primary drop-shadow-[0_0_10px_rgba(124,58,237,0.3)]">Esports</span>
        </motion.h1>
